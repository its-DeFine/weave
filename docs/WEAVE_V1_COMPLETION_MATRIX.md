...
| Textual TUI | Full-screen Textual cockpit with actionable lifecycle rail, mouse/keyboard route activation, distinct service-blueprint screens, named operator views (`overview`, `stages`, `artifacts`, `files`, `reviews`, `help`, `resume`), work pane, composer, evidence pane, stage-aware action buttons, persisted route/view resume state, and file/artifact-targeted feedback syntax. | `scripts/weave_textual_app.py`, `docs/ux/weave-v1-textual-proof/*.svg`, `docs/ux/weave-v1-textual-dogfood/*.svg`, `tests/test_weave_textual_app.py` |
...
| Visual proof | Headless Textual SVG captures and a Textual journey recording are generated from actual TUI frames with color-capable rendering, including onboarding, all core lifecycle screens, gated later-stage screens, Codex running/result frames, and every named operator view. | `scripts/capture_weave_textual_screens.py`, `scripts/weave_v1_textual_dogfood.py`, `docs/ux/weave-v1-textual-proof/`, `docs/ux/weave-v1-textual-dogfood/10-engineering-codex-running.svg`, `docs/ux/weave-v1-textual-dogfood/weave-v1-textual-dogfood-recording.svg` |
| Local dogfood | Fresh v1 backend run and fresh Textual TUI run pass through QA with real Codex execution, visible running state, file feedback, reopened/resumed QA frame, all named TUI views captured, and all service-blueprint routes captured. | `scripts/weave_v1_backend_dogfood.py`, `scripts/weave_v1_textual_dogfood.py`, `docs/proof/weave-v1-backend-dogfood.json`, `docs/proof/weave-v1-textual-dogfood.json`, `docs/ux/weave-v1-textual-dogfood/19-resume-qa.svg`, `docs/ux/weave-v1-textual-dogfood/20-view-overview.svg`, `docs/ux/weave-v1-textual-dogfood/26-view-resume.svg`, `docs/ux/weave-v1-textual-dogfood/14-gated-deployment.svg` |
