...
- eval: `packages/weave-tool/evals/lifecycle/selection.yaml`
- home procedure: `procedures/lifecycle/03-selection.md`
- app-local procedure: `apps/tiny-local-calculator/lifecycle/03-selection/procedure.md`
- primitive registry: `packages/weave-tool/primitives/registry.json` entry where `lifecycleStage` is `selection`
- relevant skills:
...
1. Observe current `selection` state, artifacts, blockers, and prior proof.
