...
- eval: `packages/weave-tool/evals/lifecycle/analysis.yaml`
- home procedure: `procedures/lifecycle/11-analysis.md`
- app-local procedure: `apps/tiny-local-calculator/lifecycle/11-analysis/procedure.md`
- primitive registry: `packages/weave-tool/primitives/registry.json` entry where `lifecycleStage` is `analysis`
- relevant skills:
...
1. Observe current `analysis` state, artifacts, blockers, and prior proof.
