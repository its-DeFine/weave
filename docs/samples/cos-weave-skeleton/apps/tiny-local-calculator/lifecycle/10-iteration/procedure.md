...
- eval: `packages/weave-tool/evals/lifecycle/iteration.yaml`
- home procedure: `procedures/lifecycle/10-iteration.md`
- app-local procedure: `apps/tiny-local-calculator/lifecycle/10-iteration/procedure.md`
- primitive registry: `packages/weave-tool/primitives/registry.json` entry where `lifecycleStage` is `iteration`
- relevant skills:
...
1. Observe current `iteration` state, artifacts, blockers, and prior proof.
