...
- eval: `packages/weave-tool/evals/lifecycle/intent.yaml`
- home procedure: `procedures/lifecycle/01-intent.md`
- app-local procedure: `apps/tiny-local-calculator/lifecycle/01-intent/procedure.md`
- primitive registry: `packages/weave-tool/primitives/registry.json` entry where `lifecycleStage` is `intent`
- relevant skills:
...
1. Observe current `intent` state, artifacts, blockers, and prior proof.
