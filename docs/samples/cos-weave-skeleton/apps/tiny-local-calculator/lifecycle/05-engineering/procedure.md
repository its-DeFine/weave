...
- eval: `packages/weave-tool/evals/lifecycle/engineering.yaml`
- home procedure: `procedures/lifecycle/05-engineering.md`
- app-local procedure: `apps/tiny-local-calculator/lifecycle/05-engineering/procedure.md`
- primitive registry: `packages/weave-tool/primitives/registry.json` entry where `lifecycleStage` is `engineering`
- relevant skills:
...
1. Observe current `engineering` state, artifacts, blockers, and prior proof.
