...
- eval: `packages/weave-tool/evals/lifecycle/qa.yaml`
- home procedure: `procedures/lifecycle/06-qa.md`
- app-local procedure: `apps/tiny-local-calculator/lifecycle/06-qa/procedure.md`
- primitive registry: `packages/weave-tool/primitives/registry.json` entry where `lifecycleStage` is `qa`
- relevant skills:
...
1. Observe current `qa` state, artifacts, blockers, and prior proof.
