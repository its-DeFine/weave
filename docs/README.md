...
- [COS WEAVE Bootstrap](COS_WEAVE_BOOTSTRAP.md)
...
- [WEAVE Symphony Adoption Plan](WEAVE_SYMPHONY_ADOPTION_PLAN.md)
- [WEAVE To Symphony Adapter CE Plan](WEAVE_SYMPHONY_ADAPTER_CE_PLAN.md)
- [WEAVE To Symphony Adapter Local MVP Runbook](WEAVE_SYMPHONY_ADAPTER_CE_PLAN.md#local-adapter-mvp-runbook)
